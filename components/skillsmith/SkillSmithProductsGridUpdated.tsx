                    ...
                    <div className="flex gap-3 w-full">
                      <motion.div className="flex-1" whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                        <CheckoutButton
                          ...
                          mode="payment"
                          vertical="sports"
                          className="w-full bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 font-bold h-11 rounded-xl btn-solid-grad"
                        />
                      </motion.div>
                    </div>
                  </div>
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-8">
              ...
              >
                <CheckoutButton
                  label="Try All Products"
                  sku={sortedProducts[0].sku}
                  mode="payment"
                  vertical="sports"
                  className="bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 font-bold px-8 py-4 h-11 rounded-xl btn-solid-grad"
                />
              </motion.div>
            </div>
          </AgentLeagueCard>
