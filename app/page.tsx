  ...
  return (
    <main className="min-h-screen relative text-white bg-transparent pt-24">
        ...
        <div className="relative z-10 pt-32 px-4 md:px-8 max-w-7xl mx-auto">
          ...
          >
            <div className="flex flex-col items-center gap-6">
              ...
              <h1 className="text-4xl md:text-6xl font-bold space-y-4">
                ...
                <span className="block text-gradient-blue">Unleash the Power of Automated Intelligence</span>
              </h1>
            </div>
            <p className="mt-6 text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed font-light">
          ...
          >
            <h2 className="text-2xl font-semibold mb-4 text-gradient">Automate, Create, Dominate — with <BrandLogo className="text-2xl inline-block" animate={false} />.</h2>
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto mt-8 text-left">
              <div className="glass-card p-6 rounded-xl hover:bg-white/20 transition-all duration-300">
