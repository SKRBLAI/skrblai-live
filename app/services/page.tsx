        ...
        <div className="relative z-10 pt-16 sm:pt-20 lg:pt-24 px-4 md:px-8 lg:px-12">
          ...
          >
            {businessSolutions.map((solution, index) => (
              ...
              >
                <GlassmorphicCard variant="floating" className="h-full relative overflow-hidden">
                  {/* Live Activity Badge */}
      ...
      <span className="text-xs text-gray-400">To Results</span>
          ...
          <AnimatePresence>
            {percyResponse && (
              ...
              >
                <GlassmorphicCard variant="floating" className="border-2 border-cyan-400/50 shadow-2xl">
          ...
          >
            ...
            <AnimatePresence mode="wait">
              <motion.div
                ...
                transition={{ duration: 0.5 }}
              >
                <GlassmorphicCard variant="floating" className="text-center">
