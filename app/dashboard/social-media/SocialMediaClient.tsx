...
export default function SocialMediaClient({ user }: SocialMediaClientProps) {
  ...
  useEffect(() => {
    ...
    const contentSub = supabase
      ...
      .on('postgres_changes', { event: '*', schema: 'public', table: 'social-content', filter: `userId=eq.${user.id}` }, (payload: any) => {
        fetchContent();
      })
      .subscribe();
        ...
        <main className="flex-1 p-6">
          ...
          >
            ...
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-3xl font-bold text-white mb-2">Social Media Dashboard</h1>
                <p className="text-gray-400">Create and manage your social media content</p>
              </div>
              <Link
                href="/dashboard"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="bg-slate-800/50 backdrop-blur-xl rounded-2xl p-6 border border-slate-700/50">
                ...
                <p className="text-gray-400 text-sm mb-4">Upload images, videos, or documents for your social media posts</p>
                <input
                  type="file"
              ...
              <div className="bg-slate-800/50 backdrop-blur-xl rounded-2xl p-6 border border-slate-700/50">
                <h3 className="text-lg font-semibold text-white mb-2">Upload Brand Assets</h3>
                <p className="text-gray-400 text-sm mb-4">Upload your brand guidelines, logos, and style guides</p>
                <input
                  type="file"
                  ...
                  onChange={(e) => {
                    const file = e.target.files?.[0];
                    if (file) {
                      console.log('Brand assets uploaded:', file);
            ...
            {/* Post Scheduler */}
            <div className="bg-slate-800/50 backdrop-blur-xl rounded-2xl p-6 border border-slate-700/50">
              <h2 className="text-xl font-semibold text-white mb-4">Schedule Posts</h2>
              <PostScheduler />
            </div>
            ...
            <div className="bg-slate-800/50 backdrop-blur-xl rounded-2xl p-6 border border-slate-700/50">
              ...
              {userContent.length > 0 ? (
                ...
                <div className="text-center py-8">
                  <p className="text-gray-400 mb-4">No content created yet</p>
                  <p className="text-sm text-gray-500">Start creating content to see it here</p>
                </div>
              )}
            </div>
