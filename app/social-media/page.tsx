          ...
          <div className="relative z-10 pt-32 pb-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <motion.div
                ...
                className="mb-16"
              >
                <GlassmorphicCard variant="floating" className="border-blue-500/20">
              ...
              >
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <GlassmorphicCard variant="floating" className="text-center border-blue-600/20 hover:border-blue-400/40 transition-colors">
                  ...
                  <GlassmorphicCard variant="floating" className="text-center border-pink-500/20 hover:border-pink-400/40 transition-colors">
                  ...
                  <GlassmorphicCard variant="floating" className="text-center border-blue-400/20 hover:border-blue-300/40 transition-colors">
                  ...
                  <GlassmorphicCard variant="floating" className="text-center border-blue-700/20 hover:border-blue-600/40 transition-colors">
                  ...
                  <GlassmorphicCard variant="floating" className="text-center border-red-600/20 hover:border-red-500/40 transition-colors">
                  ...
                  <GlassmorphicCard variant="floating" className="text-center border-black/40 hover:border-gray-600/40 transition-colors">
              ...
              <motion.div
                ...
                className="mb-16"
              >
                <GlassmorphicCard variant="floating" className="bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border-blue-500/30">
