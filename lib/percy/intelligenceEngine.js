...
/**
 * Free agents that are always accessible
 */
...
export const SUBSCRIPTION_TIERS = {
  FREE: {
    ...
    price: 0,
    agents: 2,
    features: ['Basic agents', 'Limited interactions']
  },
  STARTER: {
    name: 'Starter',
    price: 19,
    agents: 5,
    features: ['5 agents', 'Standard features', 'Email support']
  },
  PRO: {
    name: 'Pro', 
    price: 49,
    agents: -1, // unlimited
    features: ['All agents', 'Premium features', 'Priority support', 'Advanced analytics']
  },
  ENTERPRISE: {
    name: 'Enterprise',
    price: 99,
    agents: -1,
    features: ['All agents', 'White-label', 'API access', 'Custom integrations', 'Dedicated support']
  }
};
