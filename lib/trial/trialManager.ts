...
export class TrialManager {
  ...
  static getUpgradePrompt(type: UpgradePrompt['type'], daysRemaining: number): UpgradePrompt {
    const prompts: Record<UpgradePrompt['type'], UpgradePrompt> = {
      trial_expired: {
        type: 'trial_expired',
        title: '🚀 Your 3-Day Free Trial Has Ended',
        message: 'Ready to unlock the full power of SKRBL AI? Upgrade now for unlimited access to all agents, features, and workflows.',
      ...
      agent_limit: {
        ...
        message: `You've used all 3 agents for today! Upgrade to Pro for unlimited agent access and supercharge your productivity.`,
        ctaText: 'Unlock Unlimited Agents',
        urgency: 'medium',
      ...
      scan_limit: {
        ...
        message: `You've used all 3 scans for today! Upgrade to Pro for unlimited scans and instant insights.`,
        ctaText: 'Upgrade for Unlimited Scans',
        urgency: 'medium',
        showDiscount: daysRemaining <= 1,
        discountPercent: 20
      },
      day_1: {
        type: 'day_1',
        title: '🎯 Welcome to Your SKRBL AI Trial!',
        message: 'You have 2 days left to explore our powerful AI agents. Need more time? Upgrade now and get 30% off!',
        ctaText: 'Upgrade & Save 30%',
        urgency: 'low',
        showDiscount: true,
        discountPercent: 30
      },
      day_2: {
        ...
        message: 'Your trial ends tomorrow. Don\'t lose access to the AI agents that are transforming your workflow!',
      ...
      day_3: {
        ...
        message: 'Your 3-day trial expires in a few hours. Upgrade now to keep your momentum going!',
