...
export const AGENT_ACCESS_MATRIX = {
  ...
  'ad-creative-agent': ACCESS_LEVELS.FREE,
  'analytics-agent': ACCESS_LEVELS.FREE, 
  'biz-agent': ACCESS_LEVELS.FREE,
  
  // STARTER HUSTLER TIER ($27/month) - Content Creator Essentials
  'content-creator-agent': ACCESS_LEVELS.STARTER,
  ...
  'publishing-agent': ACCESS_LEVELS.STAR,
  'client-success-agent': ACCESS_LEVELS.STAR,
  ...
  'sitegen-agent': ACCESS_LEVELS.ALL_STAR,
  'proposal-generator-agent': ACCESS_LEVELS.ALL_STAR,
  'sync-agent': ACCESS_LEVELS.ALL_STAR,
